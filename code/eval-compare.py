...
def main():
	...
	parser.add_argument('--val_set', default='data/test', type=str, help='dev set path')
	parser.add_argument('--m0', default='cp1/netG_epoch_200_gpu.pth', type=str, help='model0')
	parser.add_argument('--m1', default='cp/netG_epoch_200_gpu.pth', type=str, help='model1')
	...
	with torch.no_grad():
		...
		for val_lr, val_bic, val_hr in val_bar:
			...
			netG.load_state_dict(torch.load('cp1/netG_baseline_gpu.pth'))
			sr_baseline = netG(lr)
